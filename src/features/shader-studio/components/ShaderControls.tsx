  ...
  return (
    <aside className="glass-panel absolute right-4 top-20 z-30 max-h-[calc(100vh-6rem)] w-80 space-y-4 overflow-auto rounded-xl p-4">
      ...
      <div className="space-y-1 pt-1">
        <Label>Legacy material migration</Label>
      </div>
      <ParamSlider id="twist" label="Twist" value={params.material.twist} {...PARAM_RANGE.twist} onChange={(twist) => onParamsChange({ ...params, material: { ...params.material, twist } })} />
      <ParamSlider id="pulse" label="Pulse" value={params.material.pulse} {...PARAM_RANGE.pulse} onChange={(pulse) => onParamsChange({ ...params, material: { ...params.material, pulse } })} />
      <ParamSlider id="morphFactor" label="Morph" value={params.material.morphFactor} {...PARAM_RANGE.morphFactor} onChange={(morphFactor) => onParamsChange({ ...params, material: { ...params.material, morphFactor } })} />
      <ParamSlider id="metalness" label="Metalness" value={params.material.metalness} {...PARAM_RANGE.metalness} onChange={(metalness) => onParamsChange({ ...params, material: { ...params.material, metalness } })} />
      <ParamSlider id="rimPower" label="Rim Power" value={params.material.rimPower} {...PARAM_RANGE.rimPower} onChange={(rimPower) => onParamsChange({ ...params, material: { ...params.material, rimPower } })} />
      <ParamSlider id="fresnelStrength" label="Fresnel" value={params.material.fresnelStrength} {...PARAM_RANGE.fresnelStrength} onChange={(fresnelStrength) => onParamsChange({ ...params, material: { ...params.material, fresnelStrength } })} />
