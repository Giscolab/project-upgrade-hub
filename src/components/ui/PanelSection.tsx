...
const PanelSection = forwardRef<HTMLElement, PanelSectionProps>(
  ({ title, icon, defaultOpen = true, children }, ref) => {
    const [open, setOpen] = useState(defaultOpen);

    return (
      <section ref={ref} className="rounded-md border border-[#2a2a3a] bg-[#111118]">
        <button
          type="button"
